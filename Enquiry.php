<table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC"  style="border-width: 1px; border-collapse: collapse;font-family:Trebuchet MS; font-size:13px; color:#333;">
  <tr>
  ...
  <tr>
    <td class="packers"><strong>E-mail</strong></td>
